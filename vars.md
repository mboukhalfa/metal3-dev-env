...
| VM_EXTRADISKS_FILE_SYSTEM | Create file system to VM_EXTRADISKS. By default file system is ext4, but xfs is supported and tested. | "ext4", "xfs" | "ext4" |
| VM_EXTRADISKS_MOUNT_DIR | Mount VM_EXTRADISKS partition to directory on a host. | | "/mnt/disk2" |
